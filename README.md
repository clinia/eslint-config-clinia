...
This is [Clinia](https://www.clinia.com)'s linting and formatting of JavaScript projects (Vanilla, React, Vue) repository.
...
eslint-config-clinia eslint-config-prettier \
...
```js
module.exports = {
  extends: ['clinia/flowtype', 'clinia/react']
};
```
...
```
**Note**: Be sure to put the `clinia/typescript` configuration last so the parser is properly set for TypeScript files.
...
[version-svg]: https://img.shields.io/npm/v/eslint-config-clinia.svg?style=flat-square
[package-url]: https://npmjs.org/package/eslint-config-clinia
[travis-svg]: https://img.shields.io/travis/clinia/eslint-config-clinia/master.svg?style=flat-square
[travis-url]: https://travis-ci.org/clinia/eslint-config-clinia
[license-image]: http://img.shields.io/badge/license-MIT-green.svg?style=flat-square
[license-url]: LICENSE
[downloads-image]: https://img.shields.io/npm/dm/eslint-config-clinia.svg?style=flat-square
[downloads-url]: http://npm-stat.com/charts.html?package=eslint-config-clinia